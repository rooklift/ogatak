...
translations[`简体中文`] = {
	...
	MENU_SETUP: `设置`,
		...
		MENU_LOCATE_KATAGO: `定位 KataGo...`,
		MENU_LOCATE_KATAGO_ANALYSIS_CONFIG: `定位 KataGo 配置文件...`,
		MENU_CHOOSE_WEIGHTS: `定位权重...`,
		MENU_CLEAR_CACHE: `清除 KataGo 缓存`,
		MENU_RESTART: `重新启动 KataGo`,
	...
	MENU_ANALYSIS: `分析`,
		...
		MENU_AUTOANALYSIS_VISITS: `自动分析的研究次数`,
		MENU_SET_RULES: `规则`,
			MENU_CHINESE: `中国规则`,
			MENU_JAPANESE: `日本规则`,
	...
	MENU_MISC: `其它`,
		...
		MENU_ENGINE_PLAYS_POLICY: `仅使用策略 最佳手`,
		MENU_ENGINE_PLAYS_DRUNK: `仅使用策略 飘逸`,
	...
	ABOUT_RAM_USAGE: `已使用的硬盘空间 (MB) (不包含引擎)：`,
