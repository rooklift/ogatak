...
function new_board(
	width, height, state = null, pos_hash = null, ko = null, komi = 0, active = "b", caps_by_b = 0, caps_by_w = 0, stones_b = 0, stones_w = 0) {
...
let board_prototype = {
	...
	copy: function() {
		return new_board(
			this.width, this.height, this.state, this.pos_hash, this.ko, this.komi,
