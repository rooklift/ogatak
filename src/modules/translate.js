...
translations["简体中文"] = {
	...
	MENU_TREE: "导航",			// "Navigate"
		...
		MENU_PREVIOUS_SIBLING: "Previous sibling",
		MENU_NEXT_SIBLING: "Next sibling",
		MENU_RETURN_TO_MAIN_LINE: "主要变化",
		MENU_FIND_PREVIOUS_FORK: "上一分叉",
		MENU_FIND_NEXT_FORK: "下一分叉",
		MENU_PROMOTE_LINE: "Promote line",
		MENU_PROMOTE_LINE_TO_MAIN_LINE: "设为主要变化",
	...
	MENU_DEV: "开发",
		...
		MENU_RESET_MISMATCH_WARNINGS: "Reset mismatch warnings",
		MENU_SHOW_CONFIG_FILE: "Show config file",
		MENU_TOGGLE_DEV_TOOLS: "显示/隐藏开发者工具",
